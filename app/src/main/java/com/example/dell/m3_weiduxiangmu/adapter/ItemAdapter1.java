...
public class ItemAdapter1 extends RecyclerView.Adapter<ItemAdapter1.ViewHolder>
{
    ...
    public ItemAdapter1(Context context, List<ShowBean.ResultBean.RxxpBean.CommodityListBean> list) {
    ...
    @NonNull
    @Override
    public ItemAdapter1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = View.inflate(context, R.layout.s11_layout, null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemAdapter1.ViewHolder holder, final int position)
    {
